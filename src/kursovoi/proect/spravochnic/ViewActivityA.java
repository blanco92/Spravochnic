...
public class ViewActivityA extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		String itemname = "a" + bundle.getString("defStrID"); //получаем строку и формируем имя ресурса
